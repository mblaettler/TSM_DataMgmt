...
\textbf{Functions:}
	\begin{itemize}
		\item array_to_json(anyarray), row_to_json(record), to_json(anyelement), json_array_length(json)
		\item json_object_keys(json), json_array_elements(json) expands a JSON array to a set of JSON elements
	\end{itemize}
\end{breakbox}