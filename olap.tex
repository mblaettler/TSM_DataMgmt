...
\begin{center}
\includegraphics[width=.11\textwidth]{slides_images/slice_and_dice}
\end{center}
Drill-down:
\begin{center}
\includegraphics[width=.11\textwidth]{slides_images/drill_down}
\end{center}
Roll-up:
\begin{center}
\includegraphics[width=.11\textwidth]{slides_images/roll_up}
\end{center}
\end{breakbox}
