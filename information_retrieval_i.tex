...
\end{center}
\textbf{Term Frequency Matrix/Posting-Liste}:
\begin{center}
\includegraphics[width=.05\textwidth]{slides_images/term_frequency_matrix}
\end{center}
\textbf{Dictionary}:
\begin{center}
\includegraphics[width=.05\textwidth]{slides_images/IR_dictionary}
\end{center}
...
\begin{description}
	...
	\item[Case folding] Convert everything to lowercase/uppercase for case-insensitive
	lookup.
